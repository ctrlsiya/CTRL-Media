    ...
    <nav class="navbar">
        <div class="navbar-container">
            ...
            <a href="#" class="navbar-logo">
                <img src="images/Official CTRL Media Banner Logo.png" alt="Logo" class="logo-img">
            </a>
            ...
            <ul class="navbar-menu">
                ...
                <li class="navbar-item">
                    <a href="about-us.html" class="navbar-links">About</a>
                </li>
                <li class="navbar-item">
                    <a href="services.html" class="navbar-links">Services</a>
                </li>
                <li class="navbar-item">
                    <a href="contact-us.html" class="navbar-links">Contacts</a>
                </li>
                <li class="navbar-item">
                    <a href="news-insights.html" class="navbar-links">News & Insights</a>
                </li>
